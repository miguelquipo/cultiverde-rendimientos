        ...
        if ($user && password_verify($password, $user['password'])) {
            ...
            switch ($user['role_id']) {
                case 1:
                    ...
                    break;
                case 2:
                    header("Location: /cultiverde-rendimientos/HTML/rendimientos.php");
                    break;
                case 3:
...
<body>
    ...
    <div class="login-container">
        ...
        <a href="/cultiverde-rendimientos/PHP/Usuarios/register.php" class="register-link">¿No tienes cuenta? Regístrate aquí</a>
    </div>
</body>
</html>
